...
from .schemas import (
    ...
    CheckoutRequest, CheckoutResponse, SeatLayout
)
from . import crud
from . import storage
...
app = FastAPI(
    ...
    description="Tanpa DB/JWT. In-memory movies, showtimes, seats, cart, checkout + visual layout.",
    version="1.0.0",
)
...
# NEW: layout visual (grid 2D + metadata untuk digambar di UI)
